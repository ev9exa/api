# Работа с вакансиями Кадрового Агентства
...
Если организация --- **не** Кадровое Агентство, то используется [другой набор полей](vacancies.md#add).
...
--- | --- | --- | ---
client_vacancy_request | number | Да | Идентификатор [заявки на вакансию для Кадрового Агентства](agency_vacancy_requests.md)
...
position | string | Название вакансии (должности). Определяется по полю `position` из заявки на вакансию для Кадрового Агентства

<a name="vacancy-edit"></a>
## Редактирование вакансии

Если организация --- **не** Кадровое Агентство, то используется [другой набор полей](vacancies.md#edit).
...
Если организация --- **не** Кадровое Агентство, то возвращается [другой набор полей](vacancies.md#vacancies).
...
Если организация --- **не** Кадровое Агентство, то возвращается [другой набор полей](vacancies.md#vacancy).
